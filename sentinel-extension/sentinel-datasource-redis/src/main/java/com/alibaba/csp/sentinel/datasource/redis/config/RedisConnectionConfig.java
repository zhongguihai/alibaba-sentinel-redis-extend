...
public class RedisConnectionConfig {
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.equals(redisSentinelMasterId, redisURI.redisSentinelMasterId)) {
            return false;
        }
        if (redisClusters != null ? !redisClusters.equals(redisURI.redisClusters) : redisURI.redisClusters != null) {
            return false;
        }
    ...
    public static class Builder {
        ...
        public RedisConnectionConfig build() {
            ...
            for (RedisHostAndPort sentinel : redisClusters) {
                redisConnectionConfig.getRedisClusters().add(new RedisConnectionConfig(sentinel.getHost(), sentinel.getPort(), timeout));
            }
